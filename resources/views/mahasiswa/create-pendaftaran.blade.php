...
@section('title', 'Formulir Pendaftaran - PMB Online')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="bi bi-clipboard-data me-2"></i>Formulir Pendaftaran</h2>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-info-circle me-2"></i>Isi data dengan lengkap dan benar</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('pendaftaran.store') }}" method="POST" id="pendaftaranForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="alamat_ktp" name="alamat_ktp" value="{{ old('alamat_ktp') }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="provinsi_kode" name="provinsi_kode" required>
                                ...
                                @foreach($provinsi as $prov)
                                    <option value="{{ $prov->kode }}" {{ old('provinsi_kode') == $prov->kode ? 'selected' : '' }}>{{ $prov->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kewarganegaraan" id="wni_asli" value="WNI Asli" {{ old('kewarganegaraan') == 'WNI Asli' ? 'checked' : '' }} required>
                                    <label class="form-check-label" for="wni_asli">WNI Asli</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kewarganegaraan" id="wni_keturunan" value="WNI Keturunan" {{ old('kewarganegaraan') == 'WNI Keturunan' ? 'checked' : '' }} required>
                                    <label class="form-check-label" for="wni_keturunan">WNI Keturunan</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kewarganegaraan" id="wna" value="WNA" {{ old('kewarganegaraan') == 'WNA' ? 'checked' : '' }} required>
                                    <label class="form-check-label" for="wna">WNA</label>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3" id="negara_wna" style="display: none;">
                            <label for="bila_wna_sebutkan_negara" class="form-label">Bila WNA, sebutkan negara</label>
                            <input type="text" class="form-control" id="bila_wna_sebutkan_negara" name="bila_wna_sebutkan_negara" value="{{ old('bila_wna_sebutkan_negara') }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="provinsi_lahir" name="provinsi_lahir" required>
                                <option value="">Pilih Provinsi</option>
                                @foreach($provinsi as $prov)
                                    <option value="{{ $prov->kode }}" {{ old('provinsi_lahir') == $prov->kode ? 'selected' : '' }}>{{ $prov->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-4">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" id="wanita" value="Wanita" {{ old('jenis_kelamin') == 'Wanita' ? 'checked' : '' }} required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_menikah" id="belum_menikah" value="Belum menikah" {{ old('status_menikah') == 'Belum menikah' ? 'checked' : '' }} required>
                                    <label class="form-check-label" for="belum_menikah">Belum menikah</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_menikah" id="menikah" value="Menikah" {{ old('status_menikah') == 'Menikah' ? 'checked' : '' }} required>
                                    <label class="form-check-label" for="menikah">Menikah</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_menikah" id="lain_lain" value="Lain-lain" {{ old('status_menikah') == 'Lain-lain' ? 'checked' : '' }} required>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-save me-2"></i>Simpan Pendaftaran
                                    </button>
                                </div>
                            </div>
                        </div>
